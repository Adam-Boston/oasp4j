...
public class OffermanagementImpl extends AbstractComponentFacade implements Offermanagement {
  ...
  @Override
  public SpecialOfferEto saveSpecialOffer(@Valid SpecialOfferEto specialOffer) {

    Objects.requireNonNull(specialOffer, "specialOffer");

    SpecialEntity mappedEntity = getBeanMapper().map(specialOffer, SpecialEntity.class);
    SpecialEntity persistedSpecialOffer = getSpecialDao().save(mappedEntity);
    return getBeanMapper().map(persistedSpecialOffer, SpecialOfferEto.class);
  ...
  @Override
  public void updateSpecialOffer(Long specialOfferId) {
  ...
  @Override
  public SpecialOfferEto findSpecialOffer(Long specialOfferId) {
  ...
  @Override
  public List<SpecialOfferEto> findAllSpecialOffers() {
